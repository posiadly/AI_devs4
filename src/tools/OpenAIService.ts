...
export class OpenAIService {
    ...
    public async parse<T>({ model = "gpt-4o", systemPrompt, userPrompt, responseFormat }: { model?: string, systemPrompt: string, userPrompt?: string | undefined, responseFormat: ResponseFormatJSONSchema }) {
